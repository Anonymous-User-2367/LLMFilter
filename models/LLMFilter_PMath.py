...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # Freeze Large model parameters to avoid updating during training
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # Encode tokens
        input_embeds = self.encoder(fold_out)  # Shape: [batch_size, token_num, hidden_dim_of_model]
        ...
        outputs = self.model.model(
            inputs_embeds=input_embeds)[0]  # Shape: [batch_size, prompt_token_len + token_num, hidden_dim_of_model]
    ...
    def generate_prompt_embeddings(self, bs):
        ...
        Returns:
            prompt_embeddings (Tensor): Generated prompt embeddings. Shape: [batch_size, prompt_token_len, hidden_dim_of_model].
        """
        ...
        prompt_embeddings = self.model.get_input_embeddings()(prompt.to(self.device))  # Shape: [batch_size, prompt_token_len, hidden_dim_of_model]
    ...
    def apply_prompt(self, input_embeds, batch_size):
        ...
        Args:
            input_embeds (Tensor): The input embeddings. Shape: [batch_size, token_num, hidden_dim_of_model].
