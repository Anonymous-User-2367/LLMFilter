...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        token_len = int(configs.window_length / 2)
        self.token_len = token_len  # Length of tokens for encoding/decoding
        self.enc_dim = token_len   # Dimensionality of encoder inputs
        self.ed_ratio = int(configs.state_dim / configs.obs_dim)  # Ratio for decoder dimension scaling
        self.dec_dim = self.ed_ratio * token_len  # Dimensionality of decoder outputs
